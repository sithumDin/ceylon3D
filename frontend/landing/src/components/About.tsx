    ...
    <section id="about" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-4xl sm:text-5xl mb-6 text-gray-900">Why Choose Us</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="text-lg mb-1 text-gray-900">Advanced Technology</h3>
                  <p className="text-gray-600">Latest 3D printing equipment and materials</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-gradient-to-br from-pink-500 to-purple-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  <h3 className="text-lg mb-1 text-gray-900">Expert Team</h3>
                  <p className="text-gray-600">Skilled professionals with extensive experience</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 bg-gradient-to-br from-pink-500 to-purple-500 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                ...
                <div>
                  <h3 className="text-lg mb-1 text-gray-900">Customer Focus</h3>
                  <p className="text-gray-600">Personalized service and support throughout</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            {stats.map((stat, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md text-center border border-gray-100 hover:scale-105 transition-all duration-300 cursor-pointer"
                >
